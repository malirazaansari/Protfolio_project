  ...
  return (
    <div>
      ...
      <div className="flex items-center space-x-8">
        <div className="flex flex-col justify-center items-center bg-[#4A62D6] rounded-full w-10 md:w-16 h-10 md:h-16">
          <FaPhone className="w-4 md:w-7 h-4 md:h-7 text-white" />
        </div>
        <div>
          <h1 className="font-bold text-gray-700 dark:text-white text-lg md:text-xl">
            Phone
          </h1>
