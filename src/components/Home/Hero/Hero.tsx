      ...
      <div className="flex flex-col justify-center mx-auto w-4/5 h-full">
        <div className="items-center gap-12 grid grid-cols-1 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            <h1
              data-aos="fade-left"
              className="mb-2 font-semibold text-blue-700 dark:text-gray-300 text-2xl md:text-3xl lg-text-4xl"
            >
            ...
            <h1
              data-aos="fade-right"
              data-aos-delay="100"
              className="font-bold text-gray-700 dark:text-bg text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem]"
            >
            ...
            <p
              data-aos="fade-right"
              data-aos-delay="200"
              className="mt-3 text-gray-700 dark:text-white text-sm md:text-base text-opacity-60"
            >
          ...
          <div className="relative flex justify-center items-center order-1 lg:order-2 h-[400px]">
            {/* Profile Picture */}
            <div className="z-0 relative border-[3.5px] border-blue-400 rounded-full w-[200px] h-[200px] overflow-hidden hover:scale-110 transition-transform duration-300">
              <Image
